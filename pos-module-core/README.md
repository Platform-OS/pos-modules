...
- **Module Registry & Dependency Management**: Register your module with the **module registry**. This allows you to define your module's name, version, type, and dependencies. The module registry handles **dependency management** and **outdated versions**.

- **Module Helper Functions** to verify if a module exists in the system. This feature allows other modules to use installed ones without complex dependencies.
...
You can check if a module is installed on the project:
